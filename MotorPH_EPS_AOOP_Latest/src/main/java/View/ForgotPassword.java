...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    public ForgotPassword(String username){
        ...
        otpField.setDocument(new RestrictedInput(
            false,   // allow letters
            false,   // no spaces
            false,   // allow hyphens
            false,   // no apostrophes
            true,    // no numbers
            false,   // allow uppercase
            true,   // Allow @ sign
            true,  // Allow dot sign 
            6        // max length
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        try {
            ...
            boolean updated = auth.updatePassword(username, newPassword);
            ...
            if (updated) {
                ...
                JOptionPane.showMessageDialog(this,
                    "Password not updated. User may not exist.",
                    "Warning",
                    JOptionPane.WARNING_MESSAGE);
            }
