...
public class ChangePassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MotorPHLogobig.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    // For testing purposes, provide a dummy username and get a connection
                    String testUsername = "testuser"; // Replace with a valid test username if needed
                    java.sql.Connection testConnection = Repository.DataSource.getInstance().getConnection();
                    new ChangePassword(testUsername, testConnection).setVisible(true);
                } catch (java.sql.SQLException ex) {
                    javax.swing.JOptionPane.showMessageDialog(null, "Failed to establish database connection for testing: " + ex.getMessage(), "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
                }
            }
        });
    }
